...
public class RenderUtils {
    ...
    public static void startDrawing() {
        ...
        try {
            ...
            Method method = oclass.getDeclaredMethod("setupCameraTransform", new Class[] { Float.TYPE, Integer.TYPE});
            ...
            try {
                ...
                Method method1 = oclass1.getDeclaredMethod("func_78479_a", new Class[] { Float.TYPE, Integer.TYPE});
